...
class ReadImage {
    ...
    /**
     * determinate picture font going around of perimeter pixels
     *
    ...
    int[] determBackground() {
        ...
        System.out.println("background colors : "+"r:"+background[0]+" g:"+background[1]+
    ...
    private void countingSide(int startX, int startY, int endX, int endY) {
        for (int x = startX; x < endX; x++) {
            for (int y = startY; y < endY; y++) {
                //adding every colors in font array
