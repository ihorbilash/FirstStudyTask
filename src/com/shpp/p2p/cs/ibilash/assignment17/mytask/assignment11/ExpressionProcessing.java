...
import com.shpp.p2p.cs.ibilash.assignment17.MyHashMap;
...
public class ExpressionProcessing {
     ...
     ExpressionProcessing(String[]args){
         try {
             if (args.length != 0) {
                 ...
                 MyArrayList<String> formula = addFormulaInArray(expression);// add expression to arraylist
                 ...
                 MyArrayList<String> result = calc.calculation();//after parsed - formula calculation
     ...
     */
    private MyArrayList<String> checkMinus(MyArrayList<String> formula) {
     ...
     */
    private MyArrayList<String> installArgs(MyArrayList<String> formula) {
     ...
     */
    private void checkFormula(MyArrayList<String> formula) {
        for (int i = 0; i < formula.size() - 1; i++) {
     ...
     */
    public MyArrayList<String> addFormulaInArray(String str) {
     ...
     */
    public boolean checkingDivideNull(MyArrayList<String> formula) {
     ...
     */
    public boolean checkingBracket(MyArrayList<String> formula) {
        for (int i = 0; i < formula.size(); i++) {
     ...
     */
    public MyArrayList<String> cutBracketExpression(MyArrayList<String> formula) {
     ...
     */
    private MyArrayList<String> cutPartOfExpression(MyArrayList<String> formula, int point1, int point2) {
        MyArrayList<String> newExpression = new MyArrayList<>();
