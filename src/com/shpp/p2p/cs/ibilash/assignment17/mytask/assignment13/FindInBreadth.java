...
import com.shpp.p2p.cs.ibilash.assignment17.assignment16_iterator.MyLinkedList;
 ...
 */
 class FindInBreadth {
     ...
     */
    MyArrayList<Integer> arrSilhouette = new MyArrayList<>();
    /**
     ...
     */
    MyLinkedList<Vertex> list = new MyLinkedList<>();
    /**
     ...
     */
    private int analyzer(MyArrayList<Integer> arr){
        int valMax=0;
        for(int val1:arr){
